...
function closeContact() {
    ...
    (document.getElementsByClassName("contact__textarea")[0].tabIndex = "-1"),
        ...
        nfuncCall % 2 == 0 ? $(".sign-in-link").show() : $(".sign-in-link").hide();
}
...
function checkScroll(e) {
    ...
    e > 5
        ? (menu.buttonWrapper.classList.add("menu-button__wrapper--scroll"), t && (e / document.querySelector("body").clientWidth) * 100 > 11 ? t.classList.add("tabs--scroll") : t && t.classList.remove("tabs--scroll"))
        : (menu.buttonWrapper.classList.remove("menu-button__wrapper--scroll"), t && t.classList.remove("tabs--scroll"));
}
function reSize() {
    var e = "",
        t = "",
        n = "";
    window.innerHeight < 0.564 * window.innerWidth && window.innerHeight > 0.48 * window.innerWidth
        ? ((document.getElementsByTagName("html")[0].style.overflowY = "hidden"),
          (n = -(e = 0.564 * window.innerWidth - window.innerHeight) / 56.4 + "vw"),
          (t = e / window.innerHeight),
          (document.getElementById("content_section").style.transform = "scale(" + (1 - t) + ")"),
          (document.getElementById("content_section").style.marginTop = n),
          (document.getElementsByClassName("menu-button__wrapper")[0].style.transform = "scale(" + (1 - t) + ")"),
          (document.getElementsByClassName("logo")[0].style.transform = "scale(" + (1 - t) + ")"),
          (document.getElementsByClassName("logo")[0].style.bottom = "1vw"),
          $(".bg").css({ height: window.innerHeight + "px" }))
        : ((document.getElementsByTagName("html")[0].style.overflowY = "visible"),
          (document.getElementById("content_section").style.transform = "scale(1)"),
          (document.getElementById("content_section").style.marginTop = 0),
          (document.getElementsByClassName("menu-button__wrapper")[0].style.transform = "scale(1)"),
          (document.getElementsByClassName("logo")[0].style.transform = "scale(1)"),
          (document.getElementsByClassName("logo")[0].style.top = "52.6vw")),
        window.innerHeight < 0.52 * window.innerWidth && window.innerHeight > 0.48 * window.innerWidth && $(".contact").css({ transform: "scale(0.9)", margin: "-3.2vw -2.2vw" });
}
